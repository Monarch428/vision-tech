...
const serviceStatuses = [
  {
    name: "Scan",
    detail: "Completed: 2026-03-27 10:30 AM",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Protect your devices with professional antivirus services
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-4 flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500 mb-1">Last Full Scan</p>
        ...
        {activeTab === "status" && (
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-5">
              ...
              <div className="space-y-3">
                {serviceStatuses.map((svc) => (
                  <div
                    key={svc.name}
                    className="flex items-center justify-between border border-gray-100 rounded-2xl px-4 py-4"
                  >
                    ...
                    <span
                      className={`inline-flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-full ${statusBadgeStyles[svc.status]}`}
                    >
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-5">
              ...
              <p className="text-sm text-gray-500 mb-5">
                Last full system scan - March 27, 2026
              </p>
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    <span className="text-gray-600">Files scanned</span>
                    <span className="font-bold text-gray-900">45,287</span>
                  </div>
                ...
                <div className="flex items-center gap-2 bg-green-50 rounded-2xl px-4 py-3 mt-2">
                  <svg
        ...
        {activeTab === "schedule" && (
          <div className="bg-white rounded-2xl border border-gray-200 p-5">
            <h2 className="text-lg font-bold text-gray-900 mb-1">
              Schedule Antivirus Service
            </h2>
            <p className="text-sm text-gray-500 mb-6">
              Book installation, setup, or maintenance
            </p>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-5">
              ...
              <div className="bg-blue-50 rounded-2xl p-5 mb-6">
                ...
                <p className="text-sm text-blue-700 mb-4">
                  Our security team is available to assist you with antivirus
