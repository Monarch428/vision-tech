...
function DatePicker({
  ...
  return (
    <div className="relative" ref={wrapperRef}>
      ...
      <div
        className={`absolute z-50 mt-1 transition-all duration-200 origin-top ${open
        ...
        {step === "select" && (
          <div className="px-5 py-4 space-y-4">
            ...
            <div>
              ...
              {loadingAgents ? (
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 rounded-xl bg-gray-100 border border-transparent text-md text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-400 appearance-none cursor-pointer"
                >
            ...
            <button
              ...
              className={`w-full py-2.5 rounded-xl text-sm font-semibold transition-all ${selectedAgent
                ...
                <div className="flex gap-2 mt-1">
                  {isAdmin && (
                    <button
                      ...
                      className="flex-1 text-xs font-medium text-white bg-green-500 hover:bg-green-600 rounded-lg px-2 py-1.5 transition-colors whitespace-nowrap flex items-center justify-center gap-1"
                    >
                      {assignSvg}
                      Assign
                    </button>
              ...
              <div className="hidden sm:flex items-start justify-between gap-4">
                <div className="flex flex-col gap-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <span
                      className={`text-xs px-2 py-0.5 rounded-full border ${statusStyles[ticket.status as Status] || ""
                        }`}
                    >
                      {ticket.status}
                    </span>
                    <span
                      className={`text-xs px-2 py-0.5 rounded-full ${priorityStyles[ticket.priority as Priority] || ""
                        }`}
                    >
                      {ticket.priority}
                    </span>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="mb-4">
        ...
        <p className="text-gray-700 mt-1 text-md sm:text-md">
      ...
      <div className="flex gap-1 bg-gray-100 p-1 rounded-2xl w-fit mb-2">
        {tabs.map((tab) => (
          <button
            ...
            className={`px-5 py-2 rounded-xl text-xs sm:text-sm font-medium transition-all ${activeTab === tab.id
