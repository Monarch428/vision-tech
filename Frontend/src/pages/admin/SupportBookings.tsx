...
//   return (
//     <div className="flex-1 min-w-[130px] bg-white border border-gray-300 rounded-2xl px-5 py-4">
...
//               className="w-full pl-9 pr-4 py-2 rounded-xl bg-gray-100 border border-gray-300 text-md text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400"
//             />
//           </div>
//         </div>
...
//         {/* ── Desktop MUI Table ── */}
//         <Paper elevation={0} className="hidden sm:block" sx={{ width: "100%", overflow: "hidden", borderRadius: "0 0 16px 16px", border: "1px solid #d1d5db", borderTop: "none" }}>
//           <TableContainer sx={{ maxHeight: 560 }}>
//             <Table stickyHeader aria-label="support bookings table">
//               <TableHead>
//                 <TableRow>
//                   {columns.map((h) => (
//                     <TableCell key={h} sx={{ backgroundColor: "#ffffff", fontWeight: 600, fontSize: "0.875rem", color: "#6b7280", borderBottom: "1px solid #d1d5db", py: 1.75, px: 2.5, fontFamily: "inherit", whiteSpace: "nowrap" }}>
//                       {h}
//                     </TableCell>
//                   ))}
//                 </TableRow>
...
//                 ) : (
//                   paginated.map((b) => (
//                     <TableRow key={b._id} hover sx={{ "&:hover": { backgroundColor: "rgba(249,250,251,0.8)" }, "& td": { borderBottom: "1px solid #d1d5db", py: 1.5, px: 2.5, fontFamily: "inherit" } }}>
//                       <TableCell>
