...
export interface UnclaimedDevice extends Device {
  owner: null;
}

export const getUnclaimedDevices = async (): Promise<Device[]> => {
...
export const claimDevice = async (id: string): Promise<Device> => {
